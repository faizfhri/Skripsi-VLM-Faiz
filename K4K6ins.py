...
OUTPUT_CSV     = f"hasil_qwen25instruct_{TIMESTAMP}.csv"
OUTPUT_JSON    = f"hasil_qwen25instruct_{TIMESTAMP}_detail.json"
OUTPUT_REPORT  = f"hasil_qwen25instruct_{TIMESTAMP}_report.txt"
